...
import Simple3DTest from './components/common/Simple3DTest/Simple3DTest';
import Standalone3DTest from './components/common/Standalone3DTest/Standalone3DTest';
        ...
        <GenerationProvider>
          <Router>
            ...
            <div className="content-wrapper">
              <Routes>
                <Route path="/standalone-test" element={<Standalone3DTest />} />
                ...
                <Route path="/test-3d" element={<DashboardLayout><Simple3DTest /></DashboardLayout>} />
              </Routes>
            </div>
          </Router>
        </GenerationProvider>
